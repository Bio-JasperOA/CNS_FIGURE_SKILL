...
427 passed, 2 skipped, 12 warnings in 38.72s

26 families; 54 no-subtitle figures; 26-page paired PDF; existing palette, schema and legacy script hashes unchanged.

[Build run](https://github.com/Bio-JasperOA/CNS_FIGURE_SKILL/actions/runs/35169059715) | [Machine-readable report](PUBLISH_REPORT.json). The authoring report below is historical; its earlier not-uploaded status does not describe this publication.
