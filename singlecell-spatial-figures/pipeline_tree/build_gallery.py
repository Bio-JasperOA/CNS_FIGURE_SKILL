...
def all_fixtures():
    ...
    for mid,fn in f2.FIXTURES.items():out[mid]=fn()
    return out
...
def build(root:Path):
    ...
    lines=["# Pipeline runtime synthetic gallery","","All numbers are deterministic synthetic style fixtures, not biological results.","","| Module | Generated | Skipped | Folder |","|---|---:|---:|---|"]
